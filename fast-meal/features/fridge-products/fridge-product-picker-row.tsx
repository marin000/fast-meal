...
export const ProductPickerRow = ({ item, selected, onToggle }: ProductPickerRowProps) => {
  const theme = useAppAppearance();
  ...
  return (
    <Pressable
      ...
      style={[
        styles.productRow,
        {
          backgroundColor: selected ? theme.substitutionBoxBg : theme.background,
    ...
    >
      ...
      {item.expirationDate ? <ExpirationBadge expirationDate={item.expirationDate} /> : null}
    </Pressable>
  );
};
