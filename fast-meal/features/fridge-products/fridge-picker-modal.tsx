...
export const FridgePickerModal = ({ visible, onClose, onConfirm }: FridgePickerModalProps) => {
  ...
  return (
    ...
    >
      <Pressable accessibilityRole="button" onPress={toggleAll} style={styles.selectAllRow}>
        <View
          style={[
            styles.checkbox,
            {
        ...
        >
          {allSelected ? <Ionicons name="checkmark" size={12} color="#FFFFFF" strokeWidth={3} /> : null}
        </View>

        <Text style={[styles.selectAllLabel, { color: theme.text }]}>
          {allSelected ? t('fridge.picker.deselectAll') : t('fridge.picker.selectAll')}
        </Text>
