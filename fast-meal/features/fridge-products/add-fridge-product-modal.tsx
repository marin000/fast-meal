...
export const AddFridgeProductModal = ({
	visible,
	onClose,
	onAdd,
}: AddFridgeProductModalProps) => {
	...
	return (
		<AppModal
			visible={visible}
			onClose={onClose}
			title={t("fridge.addModal.title")}
			avoidKeyboard
		>
			<View style={styles.form}>
				<View style={styles.field}>
					<Text style={[styles.label, { color: theme.text }]}>
						{t("fridge.addModal.nameLabel")}
					</Text>
					<TextInput
						value={name}
				...
				<View style={styles.field}>
					<SegmentedControl
						...
						getOptionLabel={(tab) =>
							tab === "expiration"
								? t("fridge.addModal.expirationTab")
								: t("fridge.addModal.purchasedTab")
						}
					/>
